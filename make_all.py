...
out="""
    ...
    <body>
        <div id="all">
            ...
            <p style="float:left;">
                Vice Chancellor's Senior Research Fellow in Cognitive Neuroscience<br /> 
...
out="""
    ...
    <p>2023-current: Vice Chancellor's Senior Research Fellow in Cognitive Neuroscience. The MARCS Institute for Brain, Behaviour and Development, Western Sydney University, Australia</p>
    ...
    <p>2021-2023 Mentor of 3 PhD students (OHBM International Online Mentoring Program)</p>
    <p>2020-current: Supervision of 12 honours, 4 summer/winter scholars, 3 masters students at Western Sydney University</p>
    <p>2017-2020: Co-supervision of eight honour and two masters students at the University of Sydney</p>

    <h2 class="heading">
        Teaching
    </h2>
    <p>2022 & 2023: Guest lecturer (6 lectures) for INFS7003 Advanced Topics in ICT at the Western Sydney University</p>
